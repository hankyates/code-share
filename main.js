...
var _hankyates$code_share$Gists$decodeGists = A2(
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'files', _hankyates$code_share$Gists$fileDecoder));
var _hankyates$code_share$Gists$getGist = function () {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(gist.name)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$List$map, _hankyates$code_share$Main$gistView, model.gists))
					]))
			]));
};
var _hankyates$code_share$Main$update = F2(
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							msg: _elm_lang$core$Maybe$Just(
								A2(_elm_lang$core$Debug$log, 'msg', _p0._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _hankyates$code_share$Main$Model = F3(
	function (a, b, c) {
		return {loading: a, gists: b, msg: c};
	});
var _hankyates$code_share$Main$Fail = function (a) {
	return {ctor: 'Fail', _0: a};
};
var _hankyates$code_share$Main$GistsSuccess = function (a) {
	return {ctor: 'GistsSuccess', _0: a};
};
var _hankyates$code_share$Main$init = {
	ctor: '_Tuple2',
	_0: A3(_hankyates$code_share$Main$Model, true, _hankyates$code_share$Gists$init, _elm_lang$core$Maybe$Nothing),
	_1: A3(_elm_lang$core$Task$perform, _hankyates$code_share$Main$Fail, _hankyates$code_share$Main$GistsSuccess, _hankyates$code_share$Gists$getGist)
};
var _hankyates$code_share$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _hankyates$code_share$Main$init,
			view: _hankyates$code_share$Main$view,
			update: _hankyates$code_share$Main$update,
			subscriptions: function (_p1) {
				return _elm_lang$core$Platform_Sub$none;
			}
		})
};
var _hankyates$code_share$Main$Loading = function (a) {
	return {ctor: 'Loading', _0: a};
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _hankyates$code_share$Main$main === 'undefined' ? null : _hankyates$code_share$Main$main);
